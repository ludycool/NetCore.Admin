...
using Core.PetaPocoServer.DatabaseTypes;
using Core.PetaPocoServer.Internal;
    ...
    public class Database : IDisposable
    {
        ...
        private void CommonConstruct()
        {
            ...
            if (_providerName != null)
                _factory = Core.PetaPocoServer.DbProviderFactories.GetFactory(_providerName);
        ...
        public object ZExecuteScalar(string sql, params object[] args)
        {
            try
            {
                OpenSharedConnection();
        ...
        {
            return ZExecuteScalar(sql.SQL, sql.Arguments);
        }
        ...
        /// <returns></returns>
        public int UpdateNoIn<T>(object poco, IEnumerable<string> columns)
        {
            string tableName = GetTableName<T>();
            string primaryKeyName = GetPrimaryKey<T>();
        ...
        /// <returns></returns>
        public DataTable sqlToDataTable(string sql, params object[] args)
        {
            try
            {
                OpenSharedConnection();
                try
                {
                    using (var cmd = CreateCommand(_sharedConnection, sql, args))
                    {
                        ...
                        try
                        {
                            ...
                            using (r)
                            {
                                DataTable ds = DataReaderToDataTable(r);
        ...
        /// <returns></returns>
        public DataTable sqlToDataTablePage(long page, long itemsPerPage, out long TotalPages, out long TotalItems, string sql, params object[] args)
        {
            ...
            // Get the records
            // Done
            return sqlToDataTable(sqlPage, args);
        }
        #endregion
        ...
        /// <returns></returns>
        private dynamic DataFillDynamic(IDataReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        private List<dynamic> DataFillDynamicList(IDataReader reader)
        {
